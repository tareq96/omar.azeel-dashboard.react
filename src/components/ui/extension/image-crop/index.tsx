...
import { DEFAULT_MAX_IMAGE_SIZE } from "@/constants";
...
export const ImageCropContent = ({ style, className }: ImageCropContentProps) => {
  ...
  // Prevent pointer events from propagating to parent components (e.g., Sheet)
  // This fixes conflicts with swipe-to-close gestures in sheets/drawers
  ...
  return (
    <div onPointerDown={handlePointerDown} onTouchStart={handleTouchStart}>
      <ReactCrop
      ...
      >
        {imgSrc && (
          <img
            alt="crop"
            className="max-h-[500px] w-full object-cover md:h-full"
            onLoad={onImageLoad}
            ref={imgRef}
            src={imgSrc}
          />
