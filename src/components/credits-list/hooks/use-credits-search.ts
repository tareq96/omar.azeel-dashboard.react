...
import { CREDITS_DEFAULT_SORT } from "@/components/credits-list/constants";

export type CreditsSearchState = {
  page?: number;
  per_page?: number;
  type?: string;
  q?: string;
...
export function useCreditsSearch(initial?: CreditsSearchState) {
  const [search, setSearch] = useState<CreditsSearchState>({
    page: DEFAULT_PAGE,
    per_page: DEFAULT_PER_PAGE,
    sort: CREDITS_DEFAULT_SORT,
    direction: "desc",
