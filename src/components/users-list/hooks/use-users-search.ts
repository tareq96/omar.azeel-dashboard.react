...
import { getInitialDateRange, parseDateRange } from "@/lib/utils";
...
export function useUsersSearch(initial?: UsersSearchState) {
  const [search, setSearch] = useState<UsersSearchState>({
    page: 1,
    per_page: 25,
